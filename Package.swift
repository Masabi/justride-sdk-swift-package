...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.10.1/JustRideSDK.xcframework.zip",
            checksum: "f166662f239c6ce752a7eb5cc8f893f192423a2adbfebcca80aed72cdef8b9af"
        )
    ]
)
