...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.1.0/JustRideSDK.xcframework.zip",
            checksum: "af696ea0acf179804af72e962f28fc8af8118706973ce36eb8ee15161a648bc6"
        )
    ]
)
