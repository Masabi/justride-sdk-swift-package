...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.7.0/JustRideSDK.xcframework.zip",
            checksum: "1c235b16e4ee34e0c0ff96eefb7e9de8af6b883e3bbde0f430b97fa9c8f737a0"
        )
    ]
)
