...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.2/JustRideSDK.xcframework.zip",
            checksum: "fd559c9afb55f9d4b887d0c7384c80c738b107c513733f58644090d35bbd8895"
        )
    ]
)
