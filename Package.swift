...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/20.0.0/JustRideSDK.xcframework.zip",
            checksum: "01cbcc558ebdb27219bf8dbb0861aa721dd906727d885bde670c8cc59c89f77e"
        )
    ]
)
