...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.8.0-beta1/JustRideSDK.xcframework.zip",
            checksum: "50ae8e674d468608e61916327f6e815d43ef4d606d7edc64a6e8b9b9c91da695"
        )
    ]
)
