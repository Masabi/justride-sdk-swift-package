...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/20.1.0/JustRideSDK.xcframework.zip",
            checksum: "baea80afb62c27253e87cf1f61fb3332f5a239c105b0f2a6c24ce6f85cca8c26"
        )
    ]
)
