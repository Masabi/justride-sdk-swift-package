...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.0.0-xcodetest2/JustRideSDK.xcframework.zip",
            checksum: "ca18ee6573dcc35e181276231d4e5bc3cea48e4b29c46763b7a8a86fe7e60918"
        )
    ]
)
