...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.1.0/JustRideSDK.xcframework.zip",
            checksum: "54b45c821e28ae2a4e8a5548719930a4792bd96fbe22033b010d725beb6ee096"
        )
    ]
)
