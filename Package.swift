...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.5.1/JustRideSDK.xcframework.zip",
            checksum: "677f614cab1d2bcf369117760931bb3f5545a7b14497fc9ce8c5ef13cc370540"
        )
    ]
)
