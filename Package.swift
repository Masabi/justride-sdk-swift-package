...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.6.3/JustRideSDK.xcframework.zip",
            checksum: "b5a9abd7b4e6597e5bf93aac5583dcd8a2c3c63dca69ba7f24ac72a06654d781"
        )
    ]
)
