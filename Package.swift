...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/19.0.0/JustRideSDK.xcframework.zip",
            checksum: "1759fbfed5779bd8ac576471d7d3902a973b31ab15221d6bcfeaae1aa92da520"
        )
    ]
)
