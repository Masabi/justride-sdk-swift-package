...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.2.0/JustRideSDK.xcframework.zip",
            checksum: "b5436ddb9ca7f98d56a62165372a24316539ce82c4e730eb82bedb7674a3d6f1"
        )
    ]
)
