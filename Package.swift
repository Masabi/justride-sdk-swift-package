...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/20.2.1/JustRideSDK.xcframework.zip",
            checksum: "5f22be4952e3732339963c7a81278e3780439037917adcbd921bf674321d4145"
        )
    ]
)
