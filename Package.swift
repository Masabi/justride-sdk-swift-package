...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.0.0/JustRideSDK.xcframework.zip",
            checksum: "37b56569ac01ea09391870bb43e0963001a145fd34e625a6524154d54eb2573f"
        )
    ]
)
