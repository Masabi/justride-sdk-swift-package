...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.9.0/JustRideSDK.xcframework.zip",
            checksum: "7ea1bf906e45bdf5887c32366dc9f85cefaa347307fecd09177911b058cba410"
        )
    ]
)
