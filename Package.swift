...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.3/JustRideSDK.xcframework.zip",
            checksum: "8f5c534bfa8dbca66c063a9e35cf4cbebc24e9a836db66a619e78dddda696f5f"
        )
    ]
)
