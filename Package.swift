...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.2-test6/JustRideSDK.xcframework.zip",
            checksum: "458e3674e322ea409061bb03c7534d59d3e15895917b21dd40a8ef006b9654b4"
        )
    ]
)
