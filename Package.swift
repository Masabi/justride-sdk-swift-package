...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/19.4.0/JustRideSDK.xcframework.zip",
            checksum: "a8e19038169f4bcce9283d6e9a2d917c292a8831597c317b3502f593da0a0681"
        )
    ]
)
