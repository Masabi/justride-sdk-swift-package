...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.4.0/JustRideSDK.xcframework.zip",
            checksum: "6d0614fa6f729ab750219269c8d4366babfb4bfae38d883c37104da1e0067e1e"
        )
    ]
)
