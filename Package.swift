...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.8.0-test1/JustRideSDK.xcframework.zip",
            checksum: "eb195b6ef15e308e90abd32bc0cfdaed299b63d68e42a2142f51233ba2e0b72d"
        )
    ]
)
