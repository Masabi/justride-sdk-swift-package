...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.1.0/JustRideSDK.xcframework.zip",
            checksum: "27c6a2daa477e763e301033d0126333d0ae7b9b537ab2e68f249882d0d124c43"
        )
    ]
)
