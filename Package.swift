...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.8.0-beta1/JustRideSDK.xcframework.zip",
            checksum: "1accdb21b066e38c6a42119170823403253cc94f8a4e581e50b13ab8275f6905"
        )
    ]
)
