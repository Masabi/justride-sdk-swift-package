...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.2.0/JustRideSDK.xcframework.zip",
            checksum: "560b6a9a3cabdaeddee7dee66733650918fe5ba5f6c8cdfdac2b38b0d75b477b"
        )
    ]
)
