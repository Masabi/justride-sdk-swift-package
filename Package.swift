...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.4.0/JustRideSDK.xcframework.zip",
            checksum: "6d5d3497878cd849a67ff9ad972e6835eb84b1dacd6259061b9ce5ce7caf100b"
        )
    ]
)
