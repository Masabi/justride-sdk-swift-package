...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.0.1/JustRideSDK.xcframework.zip",
            checksum: "6a6c11f15495938576251923530921132385b8496612a8736ebe333ea57fad12"
        )
    ]
)
