...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.1/JustRideSDK.xcframework.zip",
            checksum: "c6d05000003f8409a7ebf8af792c54bcf633168df99a277b4287c60711372a3d"
        )
    ]
)
