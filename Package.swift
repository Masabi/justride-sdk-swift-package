...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/19.1.0/JustRideSDK.xcframework.zip",
            checksum: "bd84ccca9c8d0d297616376c5c746c935d7b848346cb58bc482a3648c89000b7"
        )
    ]
)
