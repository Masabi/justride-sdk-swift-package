...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.3.0/JustRideSDK.xcframework.zip",
            checksum: "f9c76a9330cf4d57e6a3f9762e1c576eb14da6dd194087162d6b6289c5be3e45"
        )
    ]
)
