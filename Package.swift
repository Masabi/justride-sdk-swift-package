...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.4.0/JustRideSDK.xcframework.zip",
            checksum: "85a9840a1bbc3db9524f4f79734655df40a15cb05e40cc08fd933a1db549c855"
        )
    ]
)
