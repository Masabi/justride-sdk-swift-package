...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.8.0/JustRideSDK.xcframework.zip",
            checksum: "13c36399bf4f9ce7c0ffbb0f2bde78bd21b62c8a9d92e3bec8bc21868ccfe3f7"
        )
    ]
)
