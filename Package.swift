...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.4.0/JustRideSDK.xcframework.zip",
            checksum: "b05578110a8cb602090504dc8d6954a5938e337a653c046dfd423bff2d35f30a"
        )
    ]
)
