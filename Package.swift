...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.7.0/JustRideSDK.xcframework.zip",
            checksum: "c91c31fd54b451252f2b1897954dab0127a7c1078d969e076ea15447e6a058a9"
        )
    ]
)
