...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.2-test7/JustRideSDK.xcframework.zip",
            checksum: "2de1418a4141eeaf2b4df946c742240fe266a8f13abd8b71b6baa42e45dcf078"
        )
    ]
)
