...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.6.0/JustRideSDK.xcframework.zip",
            checksum: "8d37057c3839fb9741ba9dc54fb27acf6e2fc27f0d03d02075c51fe9e1022136"
        )
    ]
)
