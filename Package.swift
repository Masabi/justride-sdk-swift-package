...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.5.0/JustRideSDK.xcframework.zip",
            checksum: "d1d6b1d70a1821ebab56a7834ebdb3b1354212c8c5142d226453c4e7cb26345c"
        )
    ]
)
