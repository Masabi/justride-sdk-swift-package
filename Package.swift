...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.5.1-test1/JustRideSDK.xcframework.zip",
            checksum: "94d55036d4275d4f8dcdb84aae78d7128a7471c48e01cdcbc73a454d146247ae"
        )
    ]
)
