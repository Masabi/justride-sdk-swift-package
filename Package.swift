...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.7.0-test1/JustRideSDK.xcframework.zip",
            checksum: "84efdb9199fd68c8b5fcc115b0ddc831b0da988c363803c81728131d8f95e24a"
        )
    ]
)
