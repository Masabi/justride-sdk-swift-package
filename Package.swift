...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.1.0-beta1/JustRideSDK.xcframework.zip",
            checksum: "b27ade7f248bd35a4d9dd7f6967af4b8069452cf541bc6c3f9a9ed4dc1248fb1"
        )
    ]
)
