...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.10.0/JustRideSDK.xcframework.zip",
            checksum: "e88a30f2088a133db35410ed67f77bd933e4e92afba46789ed8d3dd531d83c06"
        )
    ]
)
