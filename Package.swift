...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.2.0-beta1/JustRideSDK.xcframework.zip",
            checksum: "17e29cd0a68e858e74aff815ab656afafa5de6c26c2c91d9404b7c894465516f"
        )
    ]
)
