...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/14.0.0/JustRideSDK.xcframework.zip",
            checksum: "f987a8d1db9dc83c2d1515a12a68f785aab60547b121e365899ce5dde72aff62")
    ]
)
