...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.9.0-beta1/JustRideSDK.xcframework.zip",
            checksum: "d905278bf2141471d4531bfd89aed40373b92896893364ac70735b0c3c326924"
        )
    ]
)
