...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.9.0/JustRideSDK.xcframework.zip",
            checksum: "874dfb89ec8041d2d21df1f2aa99fcb9e0d949b229e75989ae689e9e01f5d9cb"
        )
    ]
)
