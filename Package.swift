...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.9.0-beta2/JustRideSDK.xcframework.zip",
            checksum: "a1747a02758ae09427264a71cbcac9bd097eb72b14500afc7631e45d15fda6cb"
        )
    ]
)
