...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.7.0/JustRideSDK.xcframework.zip",
            checksum: "5877be08b0c08ab26300dc6cd11d7222362f279f8d581005c650666e81240c84"
        )
    ]
)
