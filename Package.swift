...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.8.0/JustRideSDK.xcframework.zip",
            checksum: "7c0628f718bb8bd32a047830fa964806c29f099f06910610066b0e1ea79a5b1b"
        )
    ]
)
