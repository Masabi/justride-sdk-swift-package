...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.0.0/JustRideSDK.xcframework.zip",
            checksum: "32bedc849339f4efa2ec1cbd1c845417bc02b4427307bf2c3a6ebbce63abd5cd"
        )
    ]
)
