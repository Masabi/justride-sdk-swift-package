...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/18.5.0/JustRideSDK.xcframework.zip",
            checksum: "d9b5d5b4c8e507bcdd44ee563a71aab723c33cd869443fae8d214e5a668401cb"
        )
    ]
)
