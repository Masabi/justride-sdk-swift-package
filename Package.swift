...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.0.0/JustRideSDK.xcframework.zip",
            checksum: "e72baf343d233763ebab8d8c0bbd1fb9065384b1ed3c3604327a4f5a0d1e2534"
        )
    ]
)
