...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/15.0.2-test4/JustRideSDK.xcframework.zip",
            checksum: "29a9917e2fc7b88d236aef218979cd5631feb545adcc18b7f5ab2cfdd152e9f3"
        )
    ]
)
