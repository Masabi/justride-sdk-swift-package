...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/17.2.0/JustRideSDK.xcframework.zip",
            checksum: "22081bdd7feddd6513968fb18dec005a13ddc6d2b45053b99ec777c6266aba4f"
        )
    ]
)
