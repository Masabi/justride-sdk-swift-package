...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/22.0.0/JustRideSDK.xcframework.zip",
            checksum: "955ed524ef7ce262d4c43b1477736eba607bb28dd918194285230743d39f7bcf"
        )
    ]
)
