...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/0.0.0-testing-new-artifactory/JustRideSDK.xcframework.zip",
            checksum: "f547755c78b67f0c033bec96d19076bdf7c8a7fd94708c9e6b9857835c7a7cf2"
        )
    ]
)
