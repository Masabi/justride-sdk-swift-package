...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/23.6.0/JustRideSDK.xcframework.zip",
            checksum: "8ab4dfd5496e2509b171c37a46cfc44d7b4f2f0bab36ac688e6d2250bb0dad43"
        )
    ]
)
