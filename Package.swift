...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/16.1.0/JustRideSDK.xcframework.zip",
            checksum: "0de40eeb2ec792b895175763dece98cc0c6ad3ac2e6e96032aaa086fe56de741"
        )
    ]
)
