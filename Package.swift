...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.0.2/JustRideSDK.xcframework.zip",
            checksum: "7dc279ccc17bffbe509a477cf01637ec09e712708f211281862acdfcb5a91257"
        )
    ]
)
