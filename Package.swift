...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/20.2.0/JustRideSDK.xcframework.zip",
            checksum: "3acfde34105fccb88220327b271382761752dbbe919ca8a9ab10a280438e690f"
        )
    ]
)
