...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "JustRideSDK",
            url: "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/21.5.0/JustRideSDK.xcframework.zip",
            checksum: "a9620782a12cbe7bf2da7d3f06db89a27aab715142215a496b420b07eefbcaeb"
        )
    ]
)
